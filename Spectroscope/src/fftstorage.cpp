...
fpoint  fftStorage::GetParabolicPoint(unsigned Number)
{
    ...
    if(!isnormal(outpnt.Frequency) ||
       ...
       abs(outpnt.Amplitude-y2*Amplifier)>1000
       ) return pnt_2;
...
std::string  fftStorage::GetWindowFuncName()
{
    switch(WindowFunc)
    {
        case Bartlett: return "Bartlett"; break;
        case Hann: return "Hann"; break;
        case Hamming: return "Hamming"; break;
        case Blackman: return "Blackman"; break;
        case BlackmanHarris: return "BlackmanHarris"; break;
        case Welch: return "Welch"; break;
        case Gaussian25: return "Gaussian25"; break;
        case Gaussian35: return "Gaussian35"; break;
        case Gaussian45: return "Gaussian45"; break;
